macro_rules! declare_constructors {
    ($foo:ident) => {
        ...
        pub fn new_a() -> NonExhaustiveFor<$foo> {
            ...
            unsafe {
                std::mem::transmute(super::example_3::Foo::A.piped(NonExhaustive::new))
            }
        }
        pub fn new_b(n: i8) -> NonExhaustiveFor<$foo> {
            #[allow(clippy::useless_transmute)]
            unsafe {
                std::mem::transmute(super::example_3::Foo::B(n).piped(NonExhaustive::new))
            }
        }
        ...
        pub fn new_c() -> NonExhaustiveFor<$foo> {
            #[allow(clippy::useless_transmute)]
            unsafe {
                std::mem::transmute(super::example_3::Foo::C.piped(NonExhaustive::new))
            }
        }
    };
}
